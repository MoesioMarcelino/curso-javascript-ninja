(function () {
    ...
    */
    ...
    if (every === true) console.log("Sim, todos os estados tem mais de 7 letras!");
    ...
    */
    ...
    if (some === true) console.log("Ceará está incluído!");
    else if (some === false) console.log("Ceará não foi incluído!");
    /*
